...
constexpr LinkSlot kCs2Slots[] = {
    ...
    { 37, "OutputTrim",         "Out Trim",         "OUT",   39,  false },
    ...
    // Compressor
    { 27, "CompThreshold",      "Comp Thr",   "THR",   24,  false, 1.0 },
    { 26, "CompRatio",          "Comp Ratio",       "RATIO", 23,  false },
    { 28, "CompRelease",        "Comp Rel",     "REL",   25,  false },
    { 24, "CompFastAttack",     "Comp F.Atk",    "F.ATK", 22,  false },
    { 25, "CompPeak",           "Comp Peak",        "PEAK",  21,  false },
    { 23, "CompMix",            "Comp Mix",         "MIX",   26,  false, 1.0 },
    // Gate
    { 30, "GateThreshold",      "Gate Thr",   "THR",   30,  false },
    { 29, "GateRange",          "Gate Range",       "RNG",   31,  false },
    { 31, "GateRelease",        "Gate Rel",     "REL",   32,  false },
...
constexpr LinkSlot k4kESlots[] = {
    ...
    { 27, "CompThreshold",      "Comp Thr",   "THR",   36,  false, 1.0 },
    { 26, "CompRatio",          "Comp Ratio",       "RATIO", 35,  false },
    { 28, "CompRelease",        "Comp Rel",     "REL",   37,  false },
    { 24, "CompFastAttack",     "Comp F.Atk",    "F.ATK", 39,  false },
    { 23, "CompMix",            "Comp Mix",         "MIX",   38,  false, 1.0 },
    { 30, "GateThreshold",      "Gate Thr",   "THR",   43,  false },
    ...
    { ext::MicDrive,       "MicDrive",       "Mic / Drive",    "MIC",    4,  false, 0.0 },
    // Output stage
...
constexpr LinkSlot k4kBSlots[] = {
    ...
    { 37, "OutputTrim",         "Out Trim",         "OUT",    7,  false },
    ...
    { 27, "CompThreshold",      "Comp Thr",   "THR",   31,  false, 1.0 },
    { 26, "CompRatio",          "Comp Ratio",       "RATIO", 30,  false },
    { 28, "CompRelease",        "Comp Rel",     "REL",   32,  false },
    { 23, "CompMix",            "Comp Mix",         "MIX",   33,  false, 1.0 },
    { 30, "GateThreshold",      "Gate Thr",   "THR",   35,  false },
...
constexpr LinkSlot k4kGSlots[] = {
    ...
    { 37, "OutputTrim",         "Out Trim",         "OUT",   14,  false },
    ...
    { 27, "CompThreshold",      "Comp Thr",   "THR",   40,  false, 1.0 },
    { 26, "CompRatio",          "Comp Ratio",       "RATIO", 39,  false },
    { 28, "CompRelease",        "Comp Rel",     "REL",   41,  false },
    { 24, "CompFastAttack",     "Comp F.Atk",    "F.ATK", 43,  false },
    { 23, "CompMix",            "Comp Mix",         "MIX",   42,  false, 1.0 },
    { 30, "GateThreshold",      "Gate Thr",   "THR",   47,  false },
    ...
    { ext::Impedance,      "Impedance",      "IMP",            "IMP",    8,  false },
    { ext::Pre,            "Pre",            "Pre",            "PRE",    9,  false },
    { ext::MicDrive,       "MicDrive",       "Mic / Drive",    "MIC",   10,  false, 0.0 },
    // Output stage
