...
| 03 | `uc1_03_layer_boot.pcapng` | Toggle UC1 between Bus Compressor mode and Channel Strip mode (physical mode button or SSL 360° UI). Several round-trips. Focused track must already have both a Bus Comp 2 and a Channel Strip 2 loaded so both layers have something to mirror. |
